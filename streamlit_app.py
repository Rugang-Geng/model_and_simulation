...
freq_arr = np.linspace(2850, 2890, 1000)
...
st.markdown("---")
st.write("Tip: Deploy this app and embed the public URL in Confluence using an iframe macro.")
